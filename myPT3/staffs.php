...
<head>
    ...
    <title>My Bike Ordering System : Staff</title>
    <!-- Bootstrap -->
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <form action="staffs.php" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="fname" type="text" class="form-control" id="stafffname" placeholder="Staff FirstName" value="<?php if (isset($_GET['edit'])) echo $editrow['fld_staff_fname']; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("select * from tbl_staffs_a175894_pt2 LIMIT $start_from, $per_page");
                        $stmt->execute();
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="staffs.php?cid=<?php echo $readrow['fld_staff_num']; ?>" class="btn btn-warning btn-xs" role="button">Details</a>
                                <a href="staffs?edit=<?php echo $readrow['fld_staff_num']; ?>" class="btn btn-success btn-xs" role="button"> Edit </a>
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        try {
                            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                            $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a175894");
                            $stmt->execute();
                            $result = $stmt->fetchAll();
