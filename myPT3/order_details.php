...
<body>
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a175894, tbl_staffs_a175894,
          tbl_customers_a175894 WHERE
          tbl_orders_a175894.fld_staff_num = tbl_staffs_a175894.fld_staff_num AND
          tbl_orders_a175894.fld_customer_num = tbl_customers_a175894.fld_customer_num AND
          fld_order_num = :oid");
                        ...
                        <div class="col-sm-9">
                            <select name="pid" class="form-control" id="prd">
                                ...
                                try {
                                    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                                    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                    $stmt = $conn->prepare("SELECT * FROM tbl_products_a175894");
                                    $stmt->execute();
                                ...
                                ?>
                                    <option value="<?php echo $productrow['fld_product_num']; ?>">
                                        <!--?php echo $productrow['fld_product_brand']." ".$productrow['fld_product_name']; ?-->
                                    </option>
                                <?php
                                }
                                $conn = null;
