...
<head>
    ...
    <title>Crispy Chip Ordering System : Customer</title>
    <!-- Bootstrap -->
            ...
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <form action="customers.php" method="post" class="form-horizontal">
                    <div class="form-group">
                        <label for="customersid" class="col-sm-3 control-label">ID</label>
                        <div class="col-sm-9">
                            <input name="cid" type="text" class="form-control" id="customersid" placeholder="Customer ID" value="<?php if (isset($_GET['edit'])) echo $editrow['fld_customer_num']; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="customerfname" class="col-sm-3 control-label">First Name</label>
                        <div class="col-sm-9">
                            <input name="name" type="text" class="form-control" id="customerfname" placeholder="Customer FirstName" value="<?php if (isset($_GET['edit'])) echo $editrow['fld_customer_fname']; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="customerlname" class="col-sm-3 control-label">Last Name</label>
                        <div class="col-sm-9">
                            <input name="price" type="text" class="form-control" id="customerlname" placeholder="Customer LastName" value="<?php if (isset($_GET['edit'])) echo $editrow['fld_customer_lname']; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <?php if (isset($_GET['edit'])) { ?>
                                <input type="hidden" name="oldcid" value="<?php echo $editrow['fld_customers_num']; ?>">
            ...
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("select * from tbl_customers_a175894_pt2 LIMIT $start_from, $per_page");
                        $stmt->execute();
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="customers.php?cid=<?php echo $readrow['fld_customer_num']; ?>" class="btn btn-warning btn-xs" role="button">Details</a>
                                <a href="customers?edit=<?php echo $readrow['fld_customer_num']; ?>" class="btn btn-success btn-xs" role="button"> Edit </a>
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        try {
                            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                            $stmt = $conn->prepare("SELECT * FROM tbl_customers_a175894_pt2");
                            $stmt->execute();
                            $result = $stmt->fetchAll();
