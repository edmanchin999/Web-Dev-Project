...
<head>
  ...
  <title>Crispy Chip Ordering System : Products</title>
  <!-- Bootstrap -->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select name="brand" class="form-control" id="productbrand" required>
                ...
                <option value="Twisties" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Twisties") echo "selected"; ?>>Twisties</option>
                <option value="Ruffles" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Ruffles") echo "selected"; ?>>Ruffles</option>
                <option value="Jack n Jill" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Jack n Jill") echo "selected"; ?>>Jack n Jill</option>
                <option value="Wise" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Wise") echo "selected"; ?>>Wise</option>
                <option value="Mister Potato" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Mister Potato") echo "selected"; ?>>Mister Potato</option>
                <option value="Jacker" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Jacker") echo "selected"; ?>>Jacker</option>
                <option value="Lays" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Lays") echo "selected"; ?>>Lays</option>
              </select>
            </div>
          </div>
          <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
        ...
        <table class="table table-striped table-bordered">
          ...
          try {
            ...
            $stmt = $conn->prepare("select * from tbl_products_a175894_pt3 LIMIT $start_from, $per_page");
            $stmt->execute();
        ...
        <nav>
          <ul class="pagination">
            ...
            try {
              $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
              $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $stmt = $conn->prepare("SELECT * FROM tbl_products_a175894_pt3");
              $stmt->execute();
              $result = $stmt->fetchAll();
